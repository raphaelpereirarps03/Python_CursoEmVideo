print("Faça um programa que solicite um número inteiro qualquer e mostre sua tabuada.")
valor = int(input("Entre com um valor qualquer para calcularmos a tabuada dele até o 10: "))
print("-" * 12)
